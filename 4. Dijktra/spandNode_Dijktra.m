function[open, closed, Gain]=spandNode_Dijktra(current, open, closed, size_grid_y, size_grid_x, obstacle, Cost, Gain)

%Realiza la expanción del nodo teniendo en cuenta los vecinos de current
...
for i=1:1:8
    ...
    gnew=calcG(current,xnext,i,Cost); %Calcula la ganancia de xnext
