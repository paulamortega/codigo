function gnew=calcG_A(current,xnext,additional_cost)

edgeCost=round(sqrt((current(1,1)-xnext(1,1))^2+(current(2,1)-xnext(2,1))^2)*10);

gnew=current(6,1)+edgeCost+additional_cost(xnext(1,1),xnext(2,1));
