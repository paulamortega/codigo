function [closed, New_start, Node_information, ocuw, open, Way]=Replaning(closed, goal, Node_information, obstacle_1, ocuw, ocuw_Obs, open, Path, size_grid_x, size_grid_y, start)
