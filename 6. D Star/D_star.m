...
% obstacle_1=[2,4;3,4;4,3;4,4;5,7;6,6;6,7;7,4;7,5]'; %Vector de Obstáculos
...
Step=Step+1; 
    ...
    [Node_information, obstacle_2, ocuw, Step]=Change_Obs(goal, Node_information, obstacle_1, ocuw, size_grid_x, size_grid_y, New_start, Step);
    ...
    if(length(obstacle_1)~=length(obstacle_2)) %Si hay mayor o menor número de obstáculos
        ...
        [closed, New_start, Node_information, ocuw, open, Way]=Replaning(closed, goal, Node_information, obstacle_1, ocuw, ocuw_Obs, open, Path, size_grid_x, size_grid_y, New_start); %Función para hacer el Replaning
        ...
        if(obstacle_1~=obstacle_2) %Se verifica si Hubo cambio en los obstáculos
           ...
           [closed, New_start, Node_information, ocuw, open, Way]=Replaning(closed, goal, Node_information, obstacle_1, ocuw, open, Path, size_grid_x, size_grid_y, New_start); %Función para hacer el Replaning
